                  ...
                  if (serverTinqfiResponse.data.reference) {
                    ...
                    const data = Convert.updateOne(
                      ...
                      const newTinqfiTrxn = {
                        ...
                        transactionState: "Successful",
                        transactionAmountInUsd: formatAmountInUsd(toValueInDollarAfterFee),
                        transactionDetails: `Converted - ${fromValue + " " + fromUppercaseToken
                          } at ${priceData[fromUppercaseToken]}- to - ${toValueAfterFee + " " + toUppercaseToken
                          } at ${priceData[toUppercaseToken]}`,
                        transactionType: "Convert",
    ...
    try {
      ...
      res.status(200).send({
        ...
        data: {
          ...
          toToken,
          toValueInDollar,
          feeInDollar: formatAmountInUsd(trxnFee),
          feeInValue: formatAmount(trxnFeeInValue),
          toValueBeforeFee: formatAmount(toValueBeforeFee),
          toValueAfterFee: formatAmount(toValueAfterFee),
        }
      });
    }
    catch (e) {
