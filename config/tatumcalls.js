...
exports.createLedgerAccount = async function (currency, xpub, externalId) {
  try {
          ...
          const callthis = async (id) => {
            ...
            const accntresponse = await axios(options)
              .then((offchainServerResponse) => {
                ...
                // console.log("here", offchainServerResponse.data)
                // return {
                //   // status: offchainServerResponse.data.statusCode,
                //   success: true,
                //   message: offchainServerResponse.data.message
                // };
              })
              .catch(function (err) {
                return {
    ...
    // console.log("here2", ledgerresponse.data);
    return {
